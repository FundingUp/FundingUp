...
import { LuArrowUpRight, LuTrendingDown, LuTrendingUp, LuHome, LuBuilding, LuMapPin, LuCalendar, LuWallet } from 'react-icons/lu';
        ...
        <div className="group relative rounded-lg bg-white transition-all duration-300 hover:-translate-y-1 shadow-xl">
            ...
            <div className="relative h-64 w-full overflow-hidden">
                <Image
                    ...
                    width={800}
                    height={600}
                    className={`h-full w-full transform object-cover rounded-t-md transition-all duration-500 ${isExpanded ? 'scale-110' : 'group-hover:scale-105'}`}
                />
